        ...
        <div className="container tab mt-4">
          ...
          <form className="row row-cols-lg-auto g-3 align-items-center mt-2">
            <div className="col-12">
              ...
              <select className="form-select" style={{ height: "36px", width: "140px" }} id="autoSizingSelect">
          ...
          <form className="row row-cols-lg-auto g-3 align-items-center mt-0 mb-4">
            <div className="col-12">
              <label className="visually-hidden" for="inlineFormInputGroupDestination">Destination</label>
              <div className="input-group">
                <input type="text" className="form-control" id="inlineFormInputGroupDestination" placeholder="Destination" />
              </div>
            </div>

            <div className="col-12">
              <label className="visually-hidden" for="inlineFormInputGroupDetails">Details</label>
              <div className="input-group">
