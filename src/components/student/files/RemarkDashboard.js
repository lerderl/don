      ...
      <div className="page-content bg-light" style={{ minHeight: "773px" }}>
        ...
        <div className="container tab mt-4">
          ...
          <form className="row row-cols-lg-auto g-3 align-items-center mt-2">
            ...
            <div className="col-12">
              <label className="visually-hidden" for="inlineFormInputGroupManagement">Management</label>
              <div className="input-group">
                <input type="text" className="form-control" id="inlineFormInputGroupManagement" placeholder="Management" />
              </div>
            </div>
          </form>
          ...
          <form className="row row-cols-lg-auto g-3 align-items-center mt-0 mb-4">
            <div className="col-12">
              <label className="visually-hidden" for="inlineFormInputGroupClassTeacher">Class Teacher</label>
              <div className="input-group">
                <input type="text" className="form-control" id="inlineFormInputGroupClassTeacher" placeholder="Class Teacher" />
              </div>
            </div>
