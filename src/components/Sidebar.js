        ...
        <div className="page-sidebar navbar-collapse collapse in">
          ...
          >
              ...
              <ul className="sub-menu">
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <Link className="ajaxify" to="/student/task/hostel">
                        Hostel Allocation
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/task/sport_members">
                        Sport Members
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/task/club_members">
                        Club Members
                      </Link>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link className="ajaxify" to="/student/setup/fee_group">
                        Fee Group
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/setup/fee_setup">
                        Fee Setup
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/setup/booklist">
                        Booklist Setup
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/setup/hostel_setup">
                        Hostel Setup
                      </Link>
                    </li>
                  </ul>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link className="ajaxify" to="/student/parent/add">
                    Add Parent
                  </Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                    <Link className="ajaxify" to="/student/employee/employment/add_employee">
                        Add Employee
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/employee/employment/new_employees">
                        New Employees
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/employee/employment/active_employees">
                        Active Employees
                      </Link>
                    </li>
                    <li>
                      <Link className="ajaxify" to="/student/employee/employment/inactive_employees">
                        Inactive Employees
                      </Link>
                    </li>
                  </ul>
